      ...
      >
        ...
        <ElRow>
          ...
          >
            <ElCol :span="12">
              <ElUpload
                v-show="form.ciStatus === 'nationalization'"
                ref="upload"
                :action="importBiz"
                :headers="HEAD"
              ...
              <ElUpload
                v-show="form.ciStatus === 'systemAssets'"
                ref="upload2"
                :action="importBiz2"
                :headers="HEAD"
                :on-change="fileChanged"
...
export default {
  ...
  methods: {
    ...
    importFile() {
      if (this.form.ciStatus === 'nationalization') {
        ...
        ;(this.$refs.form as any).validate(() => {
          const avatar = this.$refs.upload2
          if (avatar.uploadFiles.length) {
            return avatar.submit()
          }
        })
  ...
  created() {
    this.form.ciStatus = 'nationalization'
  },
}
</script>
<style lang='scss'>
