...
import { downloadTemplate, leadIn } from '@/api/assets/assetsInfo/customize'
...
export default {
  ...
  methods: {
    // 下载模板
    downloadTemplate() {
      downloadTemplate(this.ciTypeId).then(res => {
    ...
    importFile() {
      ;(this.$refs.form as any).validate(() => {
        ...
        if (avatar.uploadFiles.length > 0) {
