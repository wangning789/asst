    ...
    >
      <ElRow :class="$style.recordWrap">
        ...
        >
          <ElRow>
            ...
            >
              ...
              >
                <span>类型：</span>
                <span :class="$style.hoveTitle">{{ record.assetTypeName }}</span>
              </ElCol>
            </ElTooltip>
          </ElRow>
          <ElRow>
            ...
            >
              ...
              >
                <span>厂商：</span>
                <span :class="$style.hoveTitle">{{ record.factory }}</span>
              </ElCol>
            </ElTooltip>
          </ElRow>
          <ElRow>
            ...
            >
              ...
              >
                <span>管理地址：</span>
                <span :class="$style.hoveTitle">{{ record.assetAddress }}</span>
              </ElCol>
            </ElTooltip>
          </ElRow>
        </ElCol>
        ...
        >
          ...
          <ElButton
            v-show="!isEdit && authFit(ROLES.opertateMaintenance)"
            @click="$emit('update:visibleRecord', false)"
          >
            取消
          </ElButton>
        </ElCol>
...
// import { updataFC } from '@/api/servicePlatform/serverAssets'

export default {
  props: {
    visibleRecord: { type: Boolean, default: Boolean },
  ...
  watch: {
    ...
    'record.inspectionCompleteTime': {
      handler(val) {
        if ((val === null) && (this.record.safetyInspectionStatus === 'SYS_WAIT_INSPECTION_3') && this.authFit(ROLES.opertateMaintenance)) {
          const day = new Date()
  ...
  methods: {
    ...
    closeRecord() {
      this.$emit('update:visibleRecord', false)
      this.isEdit =
